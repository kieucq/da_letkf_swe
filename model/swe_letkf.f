...
c                                                                               
      ...
      open(27,file=ofile)
      write(27,'(6F13.6)')((u(i,j),i=1,lg),j=1,mg)
      write(27,'(6F13.6)')((v(i,j),i=1,lg),j=1,mg)
      write(27,'(6F13.6)')((z(i,j),i=1,lg),j=1,mg)
      close(27)
...
c                                                                               
      do 11102 kk= 1, jstop                                                         
        ...
        elseif (iday.lt.100) then
         ...
         print*,'truth.exe: day string length is too long...stop',iday
         stop
        endif
        if (ihour.lt.10) then
 ...
 1006    format(2x,'after invart',5x,'output step number = ',i5)
        ...
        if (restart.eq.1) then
         open(29,file='bgd.dat',status='unknown') 
