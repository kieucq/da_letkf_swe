...
!    - 09 Sep 2011: revise for 4d-letkf and parallelize the code. Note
!                   that the code is not totally optimized in terms of
!                   memory yet. The focus is only on computing speed.
!
! REFERENCE:
...
8 continue
  ...
  if (debug.ge.1) print*,'4dletkf.exe: input forecast file: ',ifile(1:20)
  open(91,file=ifile)
